...
class Ui_HomeWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.exitButton.setToolTip('Sair')
        ...
        self.searchTargetButton.setToolTip('Procurar alvo')
        ...
        self.tecnicalButton.setToolTip('Especificações Técnicas')
        ...
        self.helpButton.setToolTip('Especificações Técnicas')
